...
namespace ClientSide.VR
{
    ...
    public class WorldGen
    {
        ...
        private const string treePath = "data/NetworkEngine/custom/trees/pine/object.obj";
                ...
                {
                    {
                        ...
                        {
                            { "_uuid_", terrainId },
                            { "_diffuse_", "data/NetworkEngine/custom/terrain/Ground_d.jpg" },
                            { "_normal_", "data/NetworkEngine/custom/terrain/Ground_n.jpg" }
                        }, JsonFolder.Terrain.Path)
                    },
                });
